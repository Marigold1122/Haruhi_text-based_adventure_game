...
const outputProtocol = [
  ...
  "",
  "【判断节奏的具体提示】",
  "- 早自习、放学回家、社团日常活动、和谷口闲聊——pace=summary，timeAdvance≈1 天，segments 12-18 段，最后引向一个微选择（要不要绕路买饮料 / 是否去图书馆 / 要不要回应某条短信）",
  "- 春日突然冲过来宣布做某件事 / NPC 直接对玩家说话需要回应——pace=scene，timeAdvance≈分钟级，segments 3-8 段，立刻收到选择",
  "- 进入闭锁空间、消失事件醒来、神人出现——pace=scene，timeAdvance 跟剧情时间走，segments 5-10 段收到选择",
  "",
  "【字段约束补充】",
