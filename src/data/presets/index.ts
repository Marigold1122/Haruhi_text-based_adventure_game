...
const outputProtocol = [
  ...
  '  "eventTitle": "入学日早晨",',
  '  "narrations": [',
  '    "我把书包扔到一年六班窗边的座位——这是黑板座位表给我的位置。",',
  '    "走廊外传来一阵脚步——隔壁班的喧闹比想象中近。",',
  '    "前排男生 · 转头：「你是从哪个初中来的？」",',
  '    "我低头扣校服扣子，意识到自己得现在决定要不要搭话。"',
  "  ],",
  ...
  "  · 长度【1-18 段】，由故事流动自然决定——在你认为玩家应该做选择的瞬间收尾，不需要硬凑长度",
  "  · 旁白段：直接写一段第一人称文本",
  ...
  "  · requiresChoice：**永远为 true**——每批都要以一个让玩家做选择的瞬间收尾",
  ...
  "",
  "【判断节奏的具体提示】",
  "- 早自习、放学回家、社团日常活动、和谷口闲聊——pace=summary，timeAdvance≈1 天，narrations 12-18 段，最后引向一个微选择（要不要绕路买饮料 / 是否去图书馆 / 要不要回应某条短信）",
  "- 春日突然冲过来宣布做某件事 / NPC 直接对玩家说话需要回应——pace=scene，timeAdvance≈分钟级，narrations 3-8 段，立刻收到选择",
  "- 进入闭锁空间、消失事件醒来、神人出现——pace=scene，timeAdvance 跟剧情时间走，narrations 5-10 段收到选择",
  "",
  "【字段约束补充】",
  "  · narrations 数组长度：1-18 段，由故事流动自然决定——什么时候到达可让玩家做选择的瞬间，就在那里收尾",
...
export const dailyPreset: Preset = {
  ...
  system_prompt: [
    ...
    "【本轮节奏】默认 pace=\"summary\"。requiresChoice 永远 true——日常批次也要以一个微选择收尾（要不要绕路、要不要回应、要不要主动开口等）。",
